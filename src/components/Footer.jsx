      ...
      <footer className="relative text-white">
        ...
        <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
          <div className="flex flex-col items-center">
            <a href="#">
              <span className="text-4xl font-bold">HEALTH FITS</span>
            </a>
            <p className="mx-auto mt-4 max-w-[528px] text-center text-[#636262]">
              Chose the right workouts & stay fit. Our coaches will help you
              achieve your goals. Get special offer on shaping your body.
            </p>

            <div className="mb-16 mt-10 flex gap-7 px-6 py-2.5">
              <a
                href="#"
